...
public class Orderlist_joinDto {
	...
	public int getOrder_items_cnt() {
		return order_items_cnt;
	}
	public void setOrder_items_cnt(int order_items_cnt) {
		this.order_items_cnt = order_items_cnt;
	}
